...
module bulk_stream_fifo #(
    ...
    input  wire        s_valid,
    output wire        s_ready,
    input  wire [`BULK_STREAM_DATA_W-1:0] s_data,
    input  wire [`BULK_STREAM_KEEP_W-1:0] s_keep,
    input  wire        s_sof,
    input  wire        s_last,
    ...
    output wire        m_valid,
    input  wire        m_ready,
    output wire [`BULK_STREAM_DATA_W-1:0] m_data,
    output wire [`BULK_STREAM_KEEP_W-1:0] m_keep,
    output wire        m_sof,
    output wire        m_last,
    ...
    localparam integer PACK_W =
        `BULK_STREAM_DATA_W + `BULK_STREAM_KEEP_W + 1 + 1 +
