...
// Common offsets in every 0x100-byte module page
...
// Sensor common/specific offsets are frozen in REGISTER_MAP_FREEZE_V1.0.md.
// Member3 may add local defines matching that document, but may not change addresses.
